<?php
// Menghubungkan file konfigurast database
include 'config.php';

// Memulai sest PHP
session_start();

// Mendapatkan ID pengguna dari sest
...
if (isset($_POST['simpan'])) {
    ...
    $categoryId= $_POST["category_id"]; // 10 kategori

    // Mengatur direktort penyimpanan file gambar
